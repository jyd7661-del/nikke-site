...
| **수익** | 광고 수입 | 애드센스 **검토 요청 완료(2026-08-24) — 결과 대기**. 원래는 **원인 분리 실험**이었다(2026-08-23 반려는 옛 `*.vercel.app`에서 받은 판정이라 **도메인만 바꿔** 재심사). ⚠️ **다만 2026-08-25에 도감 실사용 데이터 + 다국어 수정을 배포해 변수가 하나가 아니게 됐다** — 유저가 알고 내린 결정이다. 결과 해석 시 반드시 감안할 것. `docs/ops.md` + `docs/open-items.md`를 **함께** 읽는다 |
