...
> 않았다.** 진행(`docs/log/2026-09.md` "클로드 플랫폼 검토"부터):
> 캐시 적중률 측정 ✅(약 28%) → **채점 실험 1차 ✅(2026-09-14)** — 스킬 원문만 주면
> Haiku 40% · Sonnet 59%로 **지금 엔진+시뮬레이터(랭커 백분위 70%)보다 낮다.** 다음은 채용률
> 티어를 함께 준 변형(`scripts/experimentAiTeams.mjs`, API 키 없이 서브에이전트로도 돈다).
