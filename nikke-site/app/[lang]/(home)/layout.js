...
// 언어별 주소(2026-09-19): 홈은 세 언어 모두 번역돼 있어 **세 언어판 모두 색인**한다.
// canonical = 자기 언어 주소, hreflang으로 세 판을 서로 잇는다(lib/locale.js). 제목·설명은 루트 레이아웃이 언어별로 준다.
export function generateMetadata({ params }) {
  return localeMeta(params.lang, '/');
}
